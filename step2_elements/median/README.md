...
The algorithm in `step1_loader/generate_points_lines.ipynb` infers the presence of the median on road based on several geometric relationships between adjacent linestrings. Detail proceesses are described as follow.
