...
# Evaluation of Transit Accessibility using GTFS and OSMnx
...
2. Download pedestrian networks and generate walk isochrones using OSMnx.  
3. Compute the significance level of each bus stop referring to a multi-factor model (E/S/F/Q).  
